;;; catppuccin-frappe-theme.el --- Catppuccin Theme
...
(autothemer-deftheme
 catppuccin-frappe "A theme based on catppuccin's amazing color scheme"
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (rosewater  "#f2d5cf" "#ffffff")
  (flamingo   "#eebebe" "#ffd7df")
  (pink       "#f4b8e4" "#d7afaf")
  (mauve      "#ca9ee6" "#d7afd7")
  (red        "#e78284" "#ff87af")
  (maroon     "#ea999c" "#ffafaf")
  (peach      "#ef9f76" "#ffaf87")
  (yellow     "#e5c890" "#ffd7af")
  (green      "#a6d189" "#87afaf")
  (teal       "#81c8be" "#afd7d7")
  (sky        "#99d1db" "#afffff")
  (sapphire   "#85c1dc" "#afffff")
  (blue       "#8caaee" "#00d7ff")
  (lavender   "#babbf1" "#d7d7ff")
  (text       "#c6d0f5" "#ffffff")
  (subtext1   "#b5bfe2" "#ffffff")
  (subtext0   "#a5adce" "#ffffff")
  (overlay2   "#949cbb" "#ffffff")
  (overlay1   "#838ba7" "#ffffff")
  (overlay0   "#737994" "#ffffff")
  (surface2   "#626880" "#ffffff")
  (surface1   "#51576d" "#ffffff")
  (surface0   "#414559" "#ffffff")
  (base       "#303446" "#ffffff")
  (mantle     "#292c3c" "#ffffff")
  (crust      "#232634" "#ffffff"))
 ...
 (
  ...
  (dired-header     (:foreground bl  (dired-mark       (:foreground peach :bold t))
