...
\end{Code}
\section{Basic}
\label{sec:org891471d}
\subsection{ID}
\label{sec:org3f93010}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Visual}
\label{sec:orge9da43c}
\subsubsection{Font}
\label{sec:orge9137e1}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsubsection{Theme}
\label{sec:org95664ae}
\begin{enumerate}
\item Catppuccin theme
\label{sec:orgaa7284f}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\section{Org-Mode}
\label{sec:org659162e}
\subsection{Defaults}
\label{sec:orgb28a781}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Visuals}
\label{sec:org4390f79}
\subsubsection{Org-modern}
\label{sec:orge4b6c5b}
\begin{Code}
\begin{Verbatim}
...
\label{sec:orgb88a5bd}
\begin{Code}
\begin{Verbatim}
\color{EFD}\EFrda{(}\EFk{package!} org-appear\EFrda{)}
\end{Verbatim}
\end{Code}
\begin{Code}
\begin{Verbatim}
\color{EFD}
\EFrda{(}\EFk{use-package!} org-appear
  \EFb{:after} org
  \EFb{:hook} \EFrdb{(}\EFo{org-mode} . \EFv{org-appear-mode}\EFrdb{)}
  \EFb{:config}
  \EFrdb{(}\EFk{setq} \EFv{org-appear-autoemphasis} t
        \EFv{org-appear-autosubmarkers} t
        \EFv{org-appear-autolinks} t\EFrdb{)}
  \EFcd{;;} \EFc{for proper first-time setup, `}\textcolor[HTML]{008b8b}{org-appear--set-elements}\EFc{'}
  \EFcd{;;} \EFc{needs to be run after other hooks have acted.}
  \EFrdb{(}\EFo{run-at-time} nil nil \EFhq{\#'}\EFhs{org-appear--set-elements}\EFrdb{)}\EFrda{)}
\end{Verbatim}
\end{Code}
\subsubsection{Ligatures}
\label{sec:org4262f64}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Agenda}
\label{sec:org8fd1804}
\subsubsection{Visual}
\label{sec:orgcc84de0}
\begin{Code}
\begin{Verbatim}
...
\label{sec:org2644f98}
\begin{Code}
\begin{Verbatim}
\color{EFD}\EFcd{;;} \EFc{(package! org-super-agenda)}
\end{Verbatim}
\end{Code}
\subsubsection{Config}
\label{sec:org54fb1db}
\begin{Code}
\begin{Verbatim}
\color{EFD}\EFrda{(}\EFk{setq}  \EFv{org-agenda-tags-column} \EFhn{0}
...
\label{sec:org09a98af}
\subsection{Roam}
\label{sec:orgada92d9}
\subsubsection{Defaults}
\label{sec:orga81f78f}
\begin{Code}
\begin{Verbatim}
\color{EFD}
...
\label{sec:orgea37fe5}
\begin{enumerate}
\item UI and visualization
\label{sec:org1f2bf6e}
\begin{Code}
\begin{Verbatim}
...
\end{enumerate}
\subsection{Ob-async}
\label{sec:orgfb48c66}
\subsubsection{Julia support}
\label{sec:orgd4ca8df}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Export}
\label{sec:orgce7e7b2}
\subsubsection{Preview}
\label{sec:orgadd5185}
\begin{Code}
\begin{Verbatim}
\color{EFD}
...
\label{sec:orgbc02c23}
\subsubsection{Citar}
\label{sec:org1b192bb}
\begin{Code}
\begin{Verbatim}
...
\label{sec:org6ae0432}
\subsubsection{Preview}
\label{sec:org3369ec5}
\begin{enumerate}
\item PNG
\label{sec:org32d086c}
\begin{Code}
\begin{Verbatim}
...
\EFs{citecolor=cite}
\EFs{\}}
\EFs{\char92{}\char92{}urlstyle\{same\}}
\EFs{\%\% hide links styles in toc}
\EFs{\char92{}\char92{}NewCommandCopy\{\char92{}\char92{}oldtoc\}\{\char92{}\char92{}tableofcontents\}}
\EFs{\char92{}\char92{}renewcommand\{\char92{}\char92{}tableofcontents\}\{\char92{}\char92{}begingroup\char92{}\char92{}hypersetup\{hidelinks\}\char92{}\char92{}oldtoc\char92{}\char92{}endgroup\}}
\EFs{"}
...
\end{enumerate}
\subsection{Capture}
\label{sec:org0e50bf6}
\subsubsection{Doct}
\label{sec:orge7d63cd}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\section{LSP}
\label{sec:orgd6512ab}
\subsection{Digestif}
\label{sec:org3404ed8}
\begin{Code}
\begin{Verbatim}
...
\EFcd{;;}   \EFc{:hook (text-mode . (lambda ()}
\EFcd{;;}                        \EFc{(require 'eglot-ltex)}
\EFcd{;;}                        \EFc{(call-interactively \#'eglot)))}
\EFcd{;;}   \EFc{:init}
\EFcd{;;}   \EFc{(setq eglot-languagetool-server-path "/opt/homebrew/Cellar/ltex-ls/15.2.0"))}
\end{Verbatim}
\end{Code}
\section{VLFI}
\label{sec:org1ff498c}
\begin{Code}
\begin{Verbatim}
...
\color{EFD}\EFrda{(}\EFk{after!} elfeed
  ...
  \EFrdb{(}\EFk{add-hook!} \EFhq{'}\EFv{elfeed-search-update-hook} \EFhq{\#'}\EFv{hide-mode-line-mode}\EFrdb{)}
