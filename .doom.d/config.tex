...
\label{sec:orgb83d332}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
(setq browse-url-chrome-program "brave")
\end{minted}
\subsubsection{Which-key}
\label{sec:orgdc3bf48}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
...
\end{minted}
\subsection{Visual}
\label{sec:org59e2296}
\subsubsection{Font}
\label{sec:org19e9e4f}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
...
\end{minted}
\section{Org-Mode}
\label{sec:orga542f91}
\subsection{Defaults}
\label{sec:org654684f}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
...
\end{minted}
\subsection{Visuals}
\label{sec:org0ace83c}
\subsubsection{Org-modern}
\label{sec:orgf2f0203}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
(package! org-modern)
\end{minted}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
...
\label{sec:org0d7997a}
\begin{enumerate}
\item UI and visualization
\label{sec:orgdaee419}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
(package! org-roam-ui)
(package! websocket)
\end{minted}
...
\end{enumerate}
\subsection{Ob-async}
\label{sec:org91628e0}
\subsubsection{Julia support}
\label{sec:org6c1960a}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
...
\label{sec:org2de976a}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
(setq ob-async-no-async-languages-alist '("jupyter-python" "jupyter-julia"))
\end{minted}
\subsection{Org-Diff}
\label{sec:org1a5dbf3}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
...
\end{minted}
\subsection{Export}
\label{sec:org8ddadf5}
\subsubsection{Preview}
\label{sec:orgbcdb315}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
...
\end{enumerate}
\subsection{Capture}
\label{sec:org6e0353b}
\subsubsection{Doct}
\label{sec:orgc5a0993}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
(package! doct)
\end{minted}
...
\end{minted}
\section{LSP}
\label{sec:org9d9386e}
\subsection{Digestif}
\label{sec:org87dbdd2}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
;; (after! lsp-mode
...
\label{sec:orge716254}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
(mu4e-alert-set-default-style 'notifier)
(add-hook 'after-init-hook #'mu4e-alert-enable-notifications)
\end{minted}
\section{RSS}
\label{sec:orge0d6603}
\begin{minted}[breaklines=true,breakanywhere=true,bgcolor=bgcolorminted,linenos=true]{common-lisp}
