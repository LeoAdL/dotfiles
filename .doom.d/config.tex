...
\definecolor{Efhi}{HTML}{9099AB}
\newcommand{\EFhi}[1]{\colorbox{Efhi}{\efstrut{}\textcolor{EFhi}{#1}}} % highlight
\definecolor{EFc}{HTML}{9099AB}
\newcommand{\EFc}[1]{\textcolor{EFc}{#1}} % font-lock-comment-face
\definecolor{EFcd}{HTML}{9099AB}
\newcommand{\EFcd}[1]{\textcolor{EFcd}{#1}} % font-lock-comment-delimiter-face
\definecolor{EFs}{HTML}{8FBCBB}
\newcommand{\EFs}[1]{\textcolor{EFs}{#1}} % font-lock-string-face
\definecolor{EFd}{HTML}{D8DEE9}
\newcommand{\EFd}[1]{\textcolor{EFd}{#1}} % font-lock-doc-face
\definecolor{EFm}{HTML}{81A1C1}
\newcommand{\EFm}[1]{\textcolor{EFm}{#1}} % font-lock-doc-markup-face
\definecolor{EFk}{HTML}{81A1C1}
\newcommand{\EFk}[1]{\textcolor{EFk}{#1}} % font-lock-keyword-face
\definecolor{EFb}{HTML}{B48EAD}
\newcommand{\EFb}[1]{\textcolor{EFb}{#1}} % font-lock-builtin-face
\definecolor{EFf}{HTML}{EBCB8B}
\newcommand{\EFf}[1]{\textcolor{EFf}{#1}} % font-lock-function-name-face
\definecolor{EFv}{HTML}{88C0D0}
\newcommand{\EFv}[1]{\textcolor{EFv}{#1}} % font-lock-variable-name-face
\definecolor{EFt}{HTML}{A3BE8C}
...
\definecolor{EFhn}{HTML}{D08770}
\newcommand{\EFhn}[1]{\textcolor{EFhn}{\textbf{#1}}} % highlight-numbers-number
\definecolor{EFhq}{HTML}{88C0D0}
\newcommand{\EFhq}[1]{\textcolor{EFhq}{#1}} % highlight-quoted-quote
\definecolor{EFhs}{HTML}{A3BE8C}
...
\end{Code}
\section{Basic}
\label{sec:org33ff2d1}
\subsection{ID}
\label{sec:orgacd5173}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Visual}
\label{sec:orgfff5299}
\subsubsection{Font}
\label{sec:org0cbfc15}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsubsection{Theme}
\label{sec:org5cf529b}
\begin{enumerate}
\item Catppuccin theme
\label{sec:org82fe4ad}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\section{Org-Mode}
\label{sec:orgeea97cc}
\subsection{Defaults}
\label{sec:orgcf5dfaf}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Visuals}
\label{sec:orge0f21a7}
\subsubsection{Org-modern}
\label{sec:org5f1796e}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Agenda}
\label{sec:orgaf9c2df}
\subsubsection{Visual}
\label{sec:org01e3db9}
\begin{Code}
\begin{Verbatim}
...
\label{sec:orgade0350}
\subsection{Roam}
\label{sec:org083ecb9}
\subsubsection{Defaults}
\label{sec:org47a783f}
\begin{Code}
\begin{Verbatim}
\color{EFD}
...
\label{sec:org1ed0d82}
\begin{enumerate}
\item UI and visualization
\label{sec:orgd1ad482}
\begin{Code}
\begin{Verbatim}
...
\end{enumerate}
\subsection{Ob-async}
\label{sec:org66654cc}
\subsubsection{Julia support}
\label{sec:orgcd2bc6e}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\subsection{Export}
\label{sec:org0d43f00}
\subsubsection{Preview}
\label{sec:org801c02f}
\begin{Code}
\begin{Verbatim}
\color{EFD}
...
\label{sec:org2c9ecf9}
\subsubsection{Citar}
\label{sec:orgc9ec621}
\begin{Code}
\begin{Verbatim}
...
\label{sec:org430450b}
\subsubsection{Preview}
\label{sec:org17b739c}
\begin{enumerate}
\item PNG
\label{sec:org77c7f2e}
\begin{Code}
\begin{Verbatim}
...
\end{Code}
\section{LSP}
\label{sec:orga1fa131}
\subsection{Digestif}
\label{sec:orga700e8f}
\begin{Code}
\begin{Verbatim}
