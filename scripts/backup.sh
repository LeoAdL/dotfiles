...
restic backup $HOME/ --exclude="$HOME/Library/**" --exclude="$HOME/Downloads/**" --exclude="$HOME/Movies/movie/**" --exclude="$HOME/Movies/series/**" --exclude="$HOME/OneDrive/**" --exclude="$HOME/Music/**" --exclude="$HOME/.Trash/**"
